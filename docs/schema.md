...
Describes a view: name, schema, SQL text, and parsed SELECT AST.
...
All name lookups are case-insensitive. The manager is stateful — re-declaring a schema clears its previous seed data and replaces earlier state.
